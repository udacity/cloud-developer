...
async function generatePassword(plainTextPassword: string): Promise<string> {
    //Use Bcrypt to GenerateSalted Hashed Passwords
...
export function requireAuth(req: Request, res: Response, next: NextFunction) {
    ...
    //Bearer asfo0a89we89fh9wehfufwufuef (we are interested in second part of text)
...
//http://udagram-okusanya-env-dev.us-east-1.elasticbeanstalk.com
