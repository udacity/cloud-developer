...
describe('concatenate function', () => {
  ...
  it('should return SlippingJimmy', () => {
    const result = concatenate("Slipping","Jimmy");
    expect(result).to.equal("SlippingJimmy");
  });

  it('should throw an error', () => {
    expect(()=>{ concatenate("Hathoda","") }).to.throw('one of your strings is empty!')
  });
