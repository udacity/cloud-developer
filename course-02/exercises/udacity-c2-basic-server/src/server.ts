...
(async () => {
  ...
  app.get( "/persons/:name", 
    ( req: Request, res: Response ) => {
      //request parameter deconstruction i.e unpack variable in "req.params" into name
      let { name } = req.params;
